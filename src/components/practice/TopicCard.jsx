...
// Memoized: only re-renders when topic or onClick reference changes.
// Removed `import * as LucideIcons` — that pulled in the entire icon library
// (~500 KB) on every render. Topics rarely have custom icons; fall back to Code.
const TopicCard = memo(({ topic, onClick }) => {
  return (
    <div
